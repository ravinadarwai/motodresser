...
?>
    ...
    $get_customers = "SELECT * FROM customer_login";
        ...
        <div id="wrapper"><!-- wrapper Starts -->
            ...
            <div id="page-wrapper"><!-- page-wrapper Starts -->
                ...
                <div class="container-fluid"><!-- container-fluid Starts -->
                    ...
                    if (isset($_GET['view_product_reviews'])) {

                        include("view_product_reviews.php");
                    }

                    if (isset($_GET['delete_product_reviews'])) {

                        include("delete_product_reviews.php");
                    }

                    if (isset($_GET['view_user_cart'])) {

                        include("view_user_cart.php");
                    }

                    if (isset($_GET['delete_user_cart'])) {

                        include("delete_user_cart.php");
                    }

                    if (isset($_GET['view_user_wishlist'])) {

                        include("view_user_wishlist.php");
                    }

                    if (isset($_GET['delete_user_wishlist'])) {

                        include("delete_user_wishlist.php");
                    }



                    if (isset($_GET['view_contact_us'])) {

                        include("view_contact_us.php");
                    }

                    if (isset($_GET['delete_contact_us'])) {

                        include("delete_contact_us.php");
                    }

                    if (isset($_GET['view_subscription'])) {
                    ...
                    if (isset($_GET['delete_subscription'])) {
                        ...
                        include("delete_subscription.php");
                    }
                    ...
                    if (isset($_GET['view_blog_comments'])) {

                        include("view_blog_comments.php");
                    }

                    if (isset($_GET['delete_blog_comment'])) {

                        include("delete_blog_comment.php");
                    }



                    if (isset($_GET['view_blog_category'])) {

                        include("view_blog_category.php");
                    }

                    if (isset($_GET['delete_blog_category'])) {

                        include("delete_blog_category.php");
                    }

                    if (isset($_GET['insert_blog_category'])) {

                        include("insert_blog_category.php");
                    }

                    if (isset($_GET['edit_blog_category'])) {

                        include("edit_blog_category.php");
                    }


                    if (isset($_GET['view_landing_images'])) {

                        include("view_landing_images.php");
                    }

                    if (isset($_GET['delete_landing_image'])) {

                        include("delete_landing_image.php");
                    }

                    if (isset($_GET['insert_landing_image'])) {

                        include("insert_landing_image.php");
                    }

                    if (isset($_GET['edit_landing_image'])) {

                        include("edit_landing_image.php");
                    }
                    ...
                    if (isset($_GET['insert_testimonial'])) {

                        include("insert_testimonial.php");
                    }
                    ...
                    if (isset($_GET['view_complete_orders'])) {

                        include("view_complete_orders.php");
                    }
