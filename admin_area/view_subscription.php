...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-dashboard"></i> Dashboard / View Subscriptions
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-envelope fa-fw"></i> View Subscriptions
                </h3>
            </div>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index?delete_subscription=<?php echo $subscription_id; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this subscription?');">
