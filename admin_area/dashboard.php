...
<div class="row">
    <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 Starts -->
        ...
        <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 Starts -->
            ...
            <a href="index?view_pending_orders">
            ...
            <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 Starts -->
                ...
                <a href="index?view_complete_orders">
...
$get_order = "select * from my_orders where order_status = 'processing' order by 1 DESC LIMIT 0,5";
...
$product_id = $row_order['products_ordered'];
...
$get_customer = "select * from customers where customer_login_id='$c_id'";
